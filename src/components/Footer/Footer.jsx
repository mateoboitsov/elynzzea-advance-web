      ...
      <div className="footer-meta">
          ...
          <div className="footer-meta-col">
            <div className="footer-meta-block">
              <div className="footer-meta-logo">
                <Copy delay={0.1}>
                  <h3 className="lg">Elynzzéa Advance</h3>
                </Copy>
              </div>
              <Copy delay={0.2}>
                <h2>Belleza que se adapta a ti, resultados que perduran</h2>
              </Copy>
            </div>
          </div>
          <div className="footer-meta-col">
        ...
        <div className="container footer-socials">
          ...
          <div className="footer-meta-col">
            <Copy delay={0.1}>
              <p>
                Creemos que la belleza no es solo estética, sino la armonía que
                moldea tu experiencia personal.
              </p>
            </Copy>
          </div>
        </div>
      ...
      <div className="footer-outro">
        <div className="container">
          <div className="footer-header">
            <img src="/logos/elynzzea-footer-logo.svg" alt="" />
          </div>
          <div className="footer-copyright">
            <p>
              Desarrollado por — <span><a href="https://maibo.agency" target="_blank" rel="noopener noreferrer">MAIBO</a></span>
            </p>
